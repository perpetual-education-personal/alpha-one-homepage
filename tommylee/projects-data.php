<?php
	...
	$projectsData = [
		[
			...
			"intro" => "The client needed a Shopify store for their newly created ecommerce hat brand. The visual aspects were set to appear as a classy and gentle brand, targetting a middle-aged audience.",
			...
			"par2" => "The client decided to use a mega menu to showcase newest arrivals. The mobile menu features useful, fast-access links. The product detail page was designed to be minimal and sophisticated.",
			...
			"key" => "hyunji",
			"title" => "Musician H. Yi",
			"intro" => "The client was in need of a personal website to present the scope of work she offers. It was important for the website to represent her individual taste. Built with HTML, CSS, Bootstrap.",
